...
public class CasNamespaceAuthenticationManagerWithAcceptUsersHandlerParserTests {
    ...
    @Test
    public void authenticationManagerWithAcceptUsersHandlerBeanDefinitionCorrectlyParsed() {
